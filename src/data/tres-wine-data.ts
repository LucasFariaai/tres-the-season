...
// Source of truth: WINE STOCK LUCAS.xlsx (live stock — stock=0 items omitted)
export const wines: Wine[] = [

  // ── SPARKLING ──
  // France · Champagne · Cuvée de Prestige
  ...
  { id: 's02', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Cuvée de Prestige', vintage: '2006', name: 'Vintage', producer: 'Krug', grapes: 'Chardonnay, Pinot Noir, Pinot Meunier', price: 840, featured: true },
  { id: 's03', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Cuvée de Prestige', vintage: '1990', name: 'R.D.', producer: 'Bollinger', grapes: '', price: 895 },
  { id: 's04', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Cuvée de Prestige', vintage: '2015', name: 'Dom Pérignon', producer: 'Dom Pérignon', grapes: 'Pinot Noir, Chardonnay', price: 560, featured: true },
  { id: 's05', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Cuvée de Prestige', vintage: '2012', name: 'Dom Pérignon Magnum', producer: 'Dom Pérignon', grapes: 'Pinot Noir, Chardonnay', price: 950, featured: true },
  // France · Champagne · Ludes
  { id: 's06', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Ludes', name: 'Brut Réserve', producer: 'Bérèche & Fils', grapes: 'Chardonnay, Pinot Meunier, Pinot Noir', price: 155 },
  { id: 's07', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Ludes', vintage: '2016', name: 'Le Cran', producer: 'Bérèche & Fils', grapes: 'Chardonnay, Pinot Noir', price: 275 },
  // France · Champagne · Côte de Bar
  { id: 's08', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Côte de Bar', vintage: '2020', name: 'Côte De Val Vilaine, Blanc de Noirs', producer: 'Roses de Jeanne', grapes: 'Pinot Noir', price: 325 },
  { id: 's09', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Côte de Bar', vintage: '2016', name: 'La Haute Lemblè, Blanc de Blanc', producer: 'Roses de Jeanne', grapes: 'Chardonnay', price: 315 },
  // France · Champagne · Aube
  { id: 's10', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Aube', vintage: '2015', name: 'Les Cogneaux', producer: 'Bénédicte Ruppert-Leroy', grapes: 'Pinot Noir', price: 155 },
  // France · Champagne · Côte de Blancs
  { id: 's11', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Côte de Blancs', vintage: '2016', name: 'Chromatique', producer: 'Stephane Regnault', grapes: 'Chardonnay', price: 220 },
  { id: 's12', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Côte de Blancs', name: 'Grand Cru Lydien 99', producer: 'Stephane Regnault', grapes: 'Chardonnay', price: 225 },
  // France · Champagne · Coteaux du Morin
  { id: 's13', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Coteaux du Morin', vintage: '2019', name: 'Les Maillons 48M, Blanc de Noirs', producer: 'Ulysse Collin', grapes: 'Pinot Noir', price: 495 },
  // France · Champagne · Vallée de Marne
  { id: 's14', category: 'sparkling', country: 'France', region: 'Champagne', subregion: 'Vallée de Marne', name: 'La Parcelle', producer: 'Chevreux Bournazel', grapes: 'Pinot Meunier, Chardonnay', price: 295 },
  // France · Jura
  { id: 's15', category: 'sparkling', country: 'France', region: 'Jura', name: 'Blanc de noir', producer: 'Blanc de noir', grapes: 'Cremant de Jura', price: 130 },
  ...
  // Germany · Mosel · Nahe
  { id: 'w02', category: 'white', country: 'Germany', region: 'Mosel', subregion: 'Nahe', vintage: '2016', name: 'Riesling GG Felsenberg', producer: 'Schäfer-Fröhlich', grapes: 'Riesling', price: 235 },
  // Germany · Mosel · Pfalz
  { id: 'w03', category: 'white', country: 'Germany', region: 'Mosel', subregion: 'Pfalz', vintage: '2019', name: 'Riesling Trocken Gaisböhl', producer: 'Dr. Bürklin-Wolf', grapes: 'Riesling', price: 165 },
  // Germany · Mosel · Rheingau
  { id: 'w04', category: 'white', country: 'Germany', region: 'Mosel', subregion: 'Rheingau', vintage: '2019', name: 'Riesling Trocken Unikat, Landgeflecht', producer: 'Peter Jakob Kühn', grapes: 'Riesling', price: 265 },
  // Germany · Mosel · Rheinhessen
  { id: 'w05', category: 'white', country: 'Germany', region: 'Mosel', subregion: 'Rheinhessen', vintage: '2021', name: 'Riesling GG ‘Aulerde’', producer: 'Wittmann', grapes: 'Riesling', price: 195 },
  { id: 'w06', category: 'white', country: 'Germany', region: 'Mosel', subregion: 'Rheinhessen', vintage: '2020', name: 'Riesling GG ‘Aulerde’', producer: 'Wittmann', grapes: 'Riesling', price: 180 },
  // Austria · Wachau
  ...
  { id: 'w13', category: 'white', country: 'France', region: 'Burgundy - Grand Cru', vintage: '2022', name: 'Hospices de Beaune, 1er Cru Cuvée Johan Humblot', producer: 'Jean-Claude Ramonet', grapes: 'Chardonnay', price: 650, featured: true },
  ...
  // France · Burgundy - Grand Cru · Pouilly-Fuissé
  { id: 'w66', category: 'white', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Pouilly-Fuissé', vintage: '2016', name: 'Vigne de a Cote', producer: 'Jules Desjourney', grapes: 'Chardonnay', price: 215 },
  ...
  // France · Burgundy - Grand Cru · Savennières
  { id: 'w69', category: 'white', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Savennières', vintage: '2022', name: 'Clos de la Coulée de Serrant', producer: 'Nicolas Joly', grapes: 'Chenin Blanc', price: 295 },
  { id: 'w70', category: 'white', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Savennières', vintage: '2020', name: 'Clos de la Coulée de Serrant', producer: 'Nicolas Joly', grapes: 'Chenin Blanc', price: 300 },
  { id: 'w71', category: 'white', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Savennières', vintage: '2020', name: 'Les Nourrissons', producer: 'Stéphane Bernaudeau', grapes: 'Chenin (Vigne Centenaire)', price: 385 },
  ...
  // Spain · Rioja
  { id: 'w74', category: 'white', country: 'Spain', region: 'Rioja', vintage: '2023', name: 'Kalamity', producer: 'Oxer', grapes: 'Viura, Calagrano', price: 280 },
  // Spain · Rioja · Chateau d’Yquem - Sauternes
  { id: 'w75', category: 'white', country: 'Spain', region: 'Rioja', subregion: 'Chateau d’Yquem - Sauternes', vintage: '2016', name: 'Chateau d’Yquem', producer: '(demi bouteilles)', grapes: 'Sémillon, Sauvignon Blanc', price: 440 },
  { id: 'w76', category: 'white', country: 'Spain', region: 'Rioja', subregion: 'Chateau d’Yquem - Sauternes', vintage: '2010', name: 'Chateau d’Yquem', producer: '(demi bouteilles)', grapes: 'Sémillon, Sauvignon Blanc', price: 485 },
  ...
  // France · Burgundy - Grand Cru · Monthélie
  { id: 'r20', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Monthélie', vintage: '2023', name: '1er Cru La Riotte', producer: 'Pierre Yves Colin-Morey', grapes: 'Pinot Noir', price: 285 },
  ...
  // France · Burgundy - Grand Cru · Savoie
  { id: 'r26', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Savoie', vintage: '2017', name: 'Vers La Maison Rouge 1.5L', producer: 'Jean Yves Péron', grapes: 'Mondeuse & Gamay', price: 205 },
  // France · Burgundy - Grand Cru · Rhône Valley
  { id: 'r27', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Rhône Valley', vintage: 'NV', name: 'VDF Les Rouliers', producer: 'Henri Bonneau', grapes: 'Grenache', price: 145 },
  // France · Burgundy - Grand Cru · Pessac-Léognan
  { id: 'r28', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Pessac-Léognan', vintage: '2017', name: 'Château La Mission Haut Brion Cru Classé', producer: 'Château La Mission Haut Brion Cru Classé', grapes: 'Cabernet Franc, Cabernet Sauvignon, Merlot', price: 635 },
  { id: 'r29', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Pessac-Léognan', vintage: '2006', name: 'Graves', producer: 'Château Pape Clément', grapes: 'Merlot, Cabernet Sauvignon', price: 275 },
  // France · Burgundy - Grand Cru · Pauillac
  { id: 'r30', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Pauillac', vintage: '2012', name: 'Château Pontet-Canet', producer: 'Château Pontet-Canet', grapes: 'Merlot, Cabernet Sauvignon', price: 325 },
  // France · Burgundy - Grand Cru · Margaux
  { id: 'r31', category: 'red', country: 'France', region: 'Burgundy - Grand Cru', subregion: 'Margaux', vintage: '2012', name: 'Château Palmer', producer: 'Château Palmer', grapes: 'Merlot, Cabernet Sauvignon', price: 665 },
  // Italy · Toscana
  { id: 'r32', category: 'red', country: 'Italy', region: 'Toscana', vintage: '2019', name: 'Sassicaia', producer: 'Tenuta San Guido', grapes: 'Cabernet Franc, Cabernet Sauvignon', price: 605 },
  ...
  { id: 'r41', category: 'red', country: 'Italy', region: 'Toscana', subregion: 'Piemonte', vintage: '2018', name: 'Barolo Francia', producer: 'Giacomo Conterno', grapes: 'Nebbiolo', price: 450 },
  { id: 'r42', category: 'red', country: 'Italy', region: 'Toscana', subregion: 'Piemonte', vintage: '2017', name: 'Barolo Francia', producer: 'Giacomo Conterno', grapes: 'Nebbiolo', price: 535 },
  { id: 'r43', category: 'red', country: 'Italy', region: 'Toscana', subregion: 'Piemonte', vintage: '2015', name: 'Barolo Francia', producer: 'Giacomo Conterno', grapes: 'Nebbiolo', price: 495 },
  ...
  // Italy · Toscana · Lombardy
  { id: 'r46', category: 'red', country: 'Italy', region: 'Toscana', subregion: 'Lombardy', vintage: '2016', name: 'Sassella Nuova Riserva', producer: 'Arpepe', grapes: 'Nebbiolo', price: 175 },
  { id: 'r47', category: 'red', country: 'Italy', region: 'Toscana', subregion: 'Lombardy', vintage: '2019', name: 'Grumello Sant’Antonio Riserva', producer: 'Arpepe', grapes: 'Nebbiolo', price: 120 },
  // Spain · Priorat
  { id: 'r48', category: 'red', country: 'Spain', region: 'Priorat', vintage: '2020', name: 'Arbossar', producer: 'Terroir al Limit', grapes: 'Carignan', price: 155 },
  // Spain · Priorat · Rioja
  { id: 'r49', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Rioja', vintage: '2020', name: 'San Quiles', producer: 'Bodegas Altun', grapes: 'Tempranillo', price: 100 },
  { id: 'r50', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Rioja', vintage: '2012', name: 'Viña Tondonia', producer: 'Bodegas Lopez de Heredia', grapes: 'Tempranillo, Garnacha, Graciano, Mazuelo', price: 135 },
  { id: 'r51', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Rioja', vintage: '2001', name: 'Viña Tondonia', producer: 'Bodegas Lopez de Heredia', grapes: 'Tempranillo, Garnacha, Graciano, Mazuelo', price: 305 },
  { id: 'r52', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Rioja', vintage: '2023', name: 'Kalamity', producer: 'Oxer', grapes: 'Tempranillo, Garnacha, Garnacha Blanca, Viura', price: 285 },
  { id: 'r53', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Rioja', vintage: '2023', name: 'Suzanne', producer: 'Oxer', grapes: 'Garnacha', price: 165 },
  // Spain · Priorat · Ribera del Duero
  { id: 'r54', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Ribera del Duero', vintage: '2012', name: 'Unico', producer: 'Bodegas Vega Sicilia', grapes: 'Tempranillo, Cabernet Sauvignon', price: 725, featured: true },
  // Spain · Priorat · Bierzo
  { id: 'r55', category: 'red', country: 'Spain', region: 'Priorat', subregion: 'Bierzo', vintage: '2020', name: 'Cobrana', producer: 'Veronica Ortega', grapes: 'Mencia', price: 120 },
]
